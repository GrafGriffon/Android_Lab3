...
public class HoroscopeActivity extends AppCompatActivity {
    ...
    RequestQueue rq;
    TextView textView2, textView1,textView3,textView4,textView5,textView6,textView7,textView8;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.mountback);
        constraintLayout.getBackground().setAlpha(101);
